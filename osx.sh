...
LAPTOP_NAME="FrostMBP"
sudo scutil --set ComputerName "$LAPTOP_NAME"
sudo scutil --set HostName "$LAPTOP_NAME"
sudo scutil --set LocalHostName "$LAPTOP_NAME"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "$LAPTOP_NAME"
...
# Require password after 3 seconds after sleep or screen saver begins
...
defaults write com.apple.dock autohide-time-modifier -float 3
